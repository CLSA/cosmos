...
class ecg_generator extends table_generator
{
  public function __construct($_stage, $_rank, $_begin_date = null, $_end_date = null)
  {
    ...
    $this->percent_keys = array('total_missing','total_skip','total_unexplained_missing','total_contraindicated');
  ...
  protected function build_data()
  {
    ...
    $sql .= 'sum(if(qcdata is null, 0, cast(trim("}" from substring_index(qcdata,":",-1)) as signed))) as total_missing, ';
    ...
    $this->page_explanation[]="total missing out of four key outcome variables";
  }
  ...
  public function build_table_data()
  {
    ...
    $this->indicator_keys[] = 'total_missing';
  }
