...
$percent_keys = array('total_left_structured_report_only','total_right_structured_report_only','total_both_structured_report','total_skip','total_unexplained_missing','total_contraindicated');
...
$page_heading = sprintf( 'CAROTID INTIMA STRUCTURED REPORT FILE RESULTS - Wave %d (%s - %s)',$rank,$begin_date,$end_date);
...
$page_explanation[]=sprintf('<li>presence of all left SR(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all left SR(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all right SR(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all SR(s)</li>');
$page_explanation[]=sprintf('<li>presence of all right SR(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all SR(s)</li>');
?>
