...
class chair_rise_generator extends table_generator
{
...
$chair_rise = new chair_rise_generator('chair_rise', $rank, $begin_date, $end_date);
...
$chair_rise->set_indicator_keys($qc_keys);
$chair_rise->set_percent_keys($percent_keys);
