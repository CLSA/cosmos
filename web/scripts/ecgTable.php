...
$percent_keys = array('total_poor_quality','total_skip','total_missing','total_contraindicated');
...
$num_qc_keys = count($qc_keys)+1; // add in poor quality column
...
$page_heading = sprintf( 'ECG RESULTS - Wave %d (%s - %s)',$rank,$begin_date,$end_date);
?>
