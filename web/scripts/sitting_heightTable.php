...
$page_explanation[]=sprintf('<li>sitting height deviation sub: size < %s cm (scale resolution)</li>',$height_dev_min);
$page_explanation[]=sprintf('<li>sitting height deviation par: %s <= size <= %s cm</li>',$height_dev_min,$height_dev_max);
$page_explanation[]=sprintf('<li>sitting height deviation sup: size > %s cm</li>',$height_dev_max);
