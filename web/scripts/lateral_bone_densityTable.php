...
class lateral_bone_density_generator extends table_generator
{
...
$lateral_bone_density = new lateral_bone_density_generator(
...
$lateral_bone_density->set_indicator_keys($qc_keys);
$lateral_bone_density->set_percent_keys($percent_keys);
