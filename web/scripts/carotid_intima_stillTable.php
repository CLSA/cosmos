...
$sql .= 'sum(if(qcdata is null, 0, if( ' .
         implode( ' and ', $and_sql ) . ',1,0))) as total_left_still_only, ';
...
$sql .= 'sum(if(qcdata is null, 0, if( ' .
         implode( ' and ', $and_sql ) . ',1,0))) as total_right_still_only, ';
...
$sql .= 'sum(if(qcdata is null, 0, if( ' .
         implode( ' and ', $and_sql ) . ',1,0))) as total_both_still, ';
...
$percent_keys = array('total_left_still_only','total_right_still_only','total_both_still','total_skip','total_unexplained_missing','total_contraindicated');
...
$page_heading = sprintf( 'CAROTID INTIMA STILL IMAGES RESULTS - Wave %d (%s - %s)',$rank,$begin_date,$end_date);
...
$page_explanation[]=sprintf('<li>presence of all left still(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all left still(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all right still(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all still(s)</li>');
$page_explanation[]=sprintf('<li>presence of all right still(s) only</li>');
$page_explanation[]=sprintf('<li>presence of all still(s)</li>');
?>
