...
class forearm_bone_density_generator extends table_generator
{
...
$forearm_bone_density = new forearm_bone_density_generator(
...
$forearm_bone_density->set_indicator_keys($qc_keys);
$forearm_bone_density->set_percent_keys($percent_keys);
