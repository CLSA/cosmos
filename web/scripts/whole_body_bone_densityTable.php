...
class whole_body_bone_density_generator extends table_generator
{
...
$whole_body_bone_density = new whole_body_bone_density_generator(
...
$whole_body_bone_density->set_indicator_keys($qc_keys);
$whole_body_bone_density->set_percent_keys($percent_keys);
