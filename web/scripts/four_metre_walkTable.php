...
class four_metre_walk_generator extends table_generator
{
  ...
  protected function build_data()
  {
    ...
    $this->page_explanation[]=sprintf(
      'congruency threshold = abs( four_metre_walk - (1.5 x four metre walk + chair rise) ) > %s sec',$this->congruency_threshold);
  }
...
$four_metre_walk = new four_metre_walk_generator('four_metre_walk', $rank, $begin_date, $end_date);
...
$four_metre_walk->set_indicator_keys($qc_keys);
$four_metre_walk->set_percent_keys($percent_keys);
