cenozoApp.defineModule( { name: 'indicator_issue_note', models: ['add', 'list', 'view'], create: module => {

  angular.extend( module, {
    identifier: {
      parent: {
        subject: 'indicator_issue',
        column: 'indicator_issue_id'
      }
    },
    name: {
      singular: 'note',
  ...
  /* ######################################################################################################## */
  cenozo.providers.factory( 'CnIndicatorIssueNoteViewFactory', [
