...
-- Wed 10 Apr 2019 02:10:50 PM EDT
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`service` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`writelog` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`role_has_service` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`setting` ;
...
-- Table `cosmos`.`access`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`access` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`technician` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`interview` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`stage_type` ;
...
-- Table `cosmos`.`stage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`stage` ;
...
-- -----------------------------------------------------
-- Table `cosmos`.`blood_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`blood_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`blood_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`blood_pressure_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`blood_pressure_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`blood_pressure_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`body_composition_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`body_composition_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`body_composition_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`carotid_intima_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`carotid_intima_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`carotid_intima_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`cdtt_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`cdtt_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`cdtt_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
  ...
  `skip` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_stage_id` (`` ASC),
  INDEX `fk_technician_id` (`` ASC),
  UNIQUE INDEX `uq_stage_id_technician_id` (`` ASC, `` ASC),
...
-- -----------------------------------------------------
-- Table `cosmos`.`chair_rise_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`chair_rise_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`chair_rise_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`cognition_recording_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`cognition_recording_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`cognition_recording_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`cognitive_test_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`cognitive_test_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`cognitive_test_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`conclusion_qnaire_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`conclusion_qnaire_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`conclusion_qnaire_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`contraindication_qnaire_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`contraindication_qnaire_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`contraindication_qnaire_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`deviation_aecrf_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`deviation_aecrf_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`deviation_aecrf_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_forearm_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_forearm_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_forearm_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_stage_id` (`stage_id` ASC),
  INDEX `fk_technician_id` (`technician_id` ASC),
  UNIQUE INDEX (`stage_id` ASC, `technician_id` ASC),
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_hip_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_hip_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_hip_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_lateral_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_lateral_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_lateral_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_qnaire_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_qnaire_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_qnaire_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_whole_body_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_whole_body_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_whole_body_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`disease_qnaire_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`disease_qnaire_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`disease_qnaire_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`ecg_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`ecg_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`ecg_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`event_pmt_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`event_pmt_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`event_pmt_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`frax_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`frax_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`frax_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`functional_status_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`functional_status_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`functional_status_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`general_health_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`general_health_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`general_health_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`grip_strength_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`grip_strength_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`grip_strength_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_stage_id` (`stage_id` ASC),
  INDEX `fk_technician_id` (`` ASC),
  UNIQUE INDEX `uq_stage_id_technician_id` (`stage_id` ASC, `` ASC),
...
-- -----------------------------------------------------
-- Table `cosmos`.`hearing_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`hearing_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`hearing_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`height_weight_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`height_weight_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`height_weight_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`hips_waist_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`hips_waist_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`hips_waist_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_2_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_2_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_2_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_3_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_3_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_3_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_4_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_4_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_4_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_conclusion_qnaire_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_conclusion_qnaire_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_conclusion_qnaire_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_consent_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_consent_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_consent_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_id_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_id_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_id_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`neuro_battery_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`neuro_battery_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`neuro_battery_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`neuro_scoring_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`neuro_scoring_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`neuro_scoring_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`os_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`os_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`os_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`osea_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`osea_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`osea_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`retinal_scan_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`retinal_scan_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`retinal_scan_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`retinal_scan_left_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`retinal_scan_left_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`retinal_scan_left_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`sitting_height_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`sitting_height_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`sitting_height_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`social_network_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`social_network_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`social_network_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`spirometry_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`spirometry_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`spirometry_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`standing_balance_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`standing_balance_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`standing_balance_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`standing_height_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`standing_height_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`standing_height_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`stroop_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`stroop_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`stroop_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`time_based_pmt_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`time_based_pmt_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`time_based_pmt_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`tug_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`tug_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`tug_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`urine_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`urine_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`urine_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`vision_acuity_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`vision_acuity_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`vision_acuity_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`walk_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`walk_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`walk_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`dexa_spine_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`dexa_spine_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`dexa_spine_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`fas_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`fas_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`fas_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_1_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_1_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_1_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_cognition_recording_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_cognition_recording_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_cognition_recording_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`inhome_qa_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`inhome_qa_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`inhome_qa_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`osonly_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`osonly_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`osonly_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`retinal_scan_right_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`retinal_scan_right_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`retinal_scan_right_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`tonometer_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`tonometer_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`tonometer_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`weight_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`weight_data` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`weight_data` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`indicator` ;
...
-- -----------------------------------------------------
-- Table `cosmos`.`study_phase_has_stage_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`study_phase_has_stage_type` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`study_phase_has_stage_type` (
  `study_phase_id` INT UNSIGNED NOT NULL,
  `stage_type_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
