...
-- Mon 01 Apr 2019 09:34:26 AM EDT
...
-- Table `cosmos`.`visit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`visit` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`visit` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_visit_site_id`
    FOREIGN KEY (`site_id`)
    REFERENCES `cenozo`.`site` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_visit_participant_id`
    FOREIGN KEY (`participant_id`)
    REFERENCES `cenozo`.`participant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `cosmos`.`stage` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_visit_id` (`visit_id` ASC),
  INDEX `fk_technician_id` (`technician_id` ASC),
  UNIQUE INDEX `uq_visit_id_technician_id_name` (`visit_id` ASC, `technician_id` ASC, `name` ASC),
  CONSTRAINT `fk_stage_visit_id`
    FOREIGN KEY (`visit_id`)
    REFERENCES `cosmos`.`visit` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`stage_has_indicator` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`site_stage_cache` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`technician_stage_cache` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`technician_indicator_cache` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`site_indicator_cache` ;
...
-- -----------------------------------------------------
-- Table `cosmos`.`visit_has_indicator`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cosmos`.`visit_has_indicator` ;

CREATE TABLE IF NOT EXISTS `cosmos`.`visit_has_indicator` (
  `visit_id` INT UNSIGNED NOT NULL,
  `indicator_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  PRIMARY KEY (`visit_id`, `indicator_id`),
  INDEX `fk_indicator_id` (`indicator_id` ASC),
  INDEX `fk_visit_id` (`visit_id` ASC),
  CONSTRAINT `fk_visit_has_indicator_visit_id`
    FOREIGN KEY (`visit_id`)
    REFERENCES `cosmos`.`visit` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_visit_has_indicator_indicator_id`
    FOREIGN KEY (`indicator_id`)
    REFERENCES `cosmos`.`indicator` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
