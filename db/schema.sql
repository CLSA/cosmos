...
-- -----------------------------------------------------
-- Table `cosmos`.`adverse_event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`adverse_event` (
...
CREATE TABLE IF NOT EXISTS `cosmos`.`comment` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_stage_id` (`stage_id` ASC),
  UNIQUE INDEX `uq_stage_id_rank` (`stage_id` ASC, `rank` ASC),
...
-- -----------------------------------------------------
-- Table `cosmos`.`indicator_issue`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`indicator_issue` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`indicator_issue_has_stage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`indicator_issue_has_stage` (
  ...
  CONSTRAINT `fk_indicator_issue_has_stage_indicator_issue_id`
    ...
    REFERENCES `cosmos`.`indicator_issue` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cosmos`.`indicator_issue_note`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`indicator_issue_note` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `indicator_issue_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`stage_issue`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`stage_issue` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `technician_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `cosmos`.`stage_issue_has_stage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`stage_issue_has_stage` (
  ...
  CONSTRAINT `fk_stage_issue_has_stage_stage_issue_id`
    ...
    REFERENCES `cosmos`.`stage_issue` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cosmos`.`stage_issue_note`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cosmos`.`stage_issue_note` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `stage_issue_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- procedure update_outlier_for_indicator
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure update_outlier_for_stage_type
-- -----------------------------------------------------
