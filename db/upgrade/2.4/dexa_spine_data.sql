SELECT "Creating new dexa_spine_data table" AS "";

CREATE TABLE IF NOT EXISTS dexa_spine_data (
  ...
  CONSTRAINT fk_dexa_spine_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_dexa_spine_data_stage_id
