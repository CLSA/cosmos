SELECT "Creating new vision_acuity_data table" AS "";

CREATE TABLE IF NOT EXISTS vision_acuity_data (
  ...
  CONSTRAINT fk_vision_acuity_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_vision_acuity_data_stage_id
