SELECT "Creating new standing_balance_data table" AS "";

CREATE TABLE IF NOT EXISTS standing_balance_data (
  ...
  CONSTRAINT fk_standing_balance_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_standing_balance_data_stage_id
