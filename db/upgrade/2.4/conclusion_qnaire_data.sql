SELECT "Creating new conclusion_qnaire_data table" AS "";

CREATE TABLE IF NOT EXISTS conclusion_qnaire_data (
  ...
  CONSTRAINT fk_conclusion_qnaire_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_conclusion_qnaire_data_stage_id
