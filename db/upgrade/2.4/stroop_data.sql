SELECT "Creating new stroop_data table" AS "";

CREATE TABLE IF NOT EXISTS stroop_data (
  ...
  CONSTRAINT fk_stroop_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_stroop_data_stage_id
