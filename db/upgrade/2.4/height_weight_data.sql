SELECT "Creating new height_weight_data table" AS "";

CREATE TABLE IF NOT EXISTS height_weight_data (
  ...
  CONSTRAINT fk_height_weight_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_height_weight_data_stage_id
