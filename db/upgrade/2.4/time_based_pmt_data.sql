SELECT "Creating new time_based_pmt_data table" AS "";

CREATE TABLE IF NOT EXISTS time_based_pmt_data (
  ...
  CONSTRAINT fk_time_based_pmt_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_time_based_pmt_data_stage_id
