SELECT "Creating new dexa_lateral_data table" AS "";

CREATE TABLE IF NOT EXISTS dexa_lateral_data (
  ...
  CONSTRAINT fk_dexa_lateral_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_dexa_lateral_data_stage_id
