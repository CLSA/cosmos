SELECT "Creating new inhome_cognition_recording_data table" AS "";

CREATE TABLE IF NOT EXISTS inhome_cognition_recording_data (
  ...
  CONSTRAINT fk_inhome_cognition_recording_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_inhome_cognition_recording_data_stage_id
