SELECT "Creating new body_composition_data table" AS "";

CREATE TABLE IF NOT EXISTS body_composition_data (
  ...
  CONSTRAINT fk_body_composition_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_body_composition_data_stage_id
