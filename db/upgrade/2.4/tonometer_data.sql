SELECT "Creating new tonometer_data table" AS "";

CREATE TABLE IF NOT EXISTS tonometer_data (
  ...
  CONSTRAINT fk_tonometer_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_tonometer_data_stage_id
