SELECT "Creating new neuro_battery_data table" AS "";

CREATE TABLE IF NOT EXISTS neuro_battery_data (
  ...
  CONSTRAINT fk_neuro_battery_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_neuro_battery_data_stage_id
