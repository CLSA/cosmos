SELECT "Creating new general_health_data table" AS "";

CREATE TABLE IF NOT EXISTS general_health_data (
  ...
  CONSTRAINT fk_general_health_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_general_health_data_stage_id
