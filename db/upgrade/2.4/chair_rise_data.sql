SELECT "Creating new chair_rise_data table" AS "";

CREATE TABLE IF NOT EXISTS chair_rise_data (
  ...
  CONSTRAINT fk_chair_rise_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_chair_rise_data_stage_id
