SELECT "Creating new cognitive_test_data table" AS "";

CREATE TABLE IF NOT EXISTS cognitive_test_data (
  ...
  CONSTRAINT fk_cognitive_test_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_cognitive_test_data_stage_id
