SELECT "Creating new neuro_scoring_data table" AS "";

CREATE TABLE IF NOT EXISTS neuro_scoring_data (
  ...
  CONSTRAINT fk_neuro_scoring_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_neuro_scoring_data_stage_id
