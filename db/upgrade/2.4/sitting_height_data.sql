SELECT "Creating new sitting_height_data table" AS "";

CREATE TABLE IF NOT EXISTS sitting_height_data (
  ...
  CONSTRAINT fk_sitting_height_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_sitting_height_data_stage_id
