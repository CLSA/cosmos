SELECT "Creating new osonly_data table" AS "";

CREATE TABLE IF NOT EXISTS osonly_data (
  ...
  CONSTRAINT fk_osonly_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_osonly_data_stage_id
