SELECT "Creating new grip_strength_data table" AS "";

CREATE TABLE IF NOT EXISTS grip_strength_data (
  ...
  CONSTRAINT fk_grip_strength_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_grip_strength_data_stage_id
