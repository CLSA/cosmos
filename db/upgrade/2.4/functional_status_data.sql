SELECT "Creating new functional_status_data table" AS "";

CREATE TABLE IF NOT EXISTS functional_status_data (
  ...
  CONSTRAINT fk_functional_status_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_functional_status_data_stage_id
