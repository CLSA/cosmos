SELECT "Creating new hips_waist_data table" AS "";

CREATE TABLE IF NOT EXISTS hips_waist_data (
  ...
  CONSTRAINT fk_hips_waist_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_hips_waist_data_stage_id
