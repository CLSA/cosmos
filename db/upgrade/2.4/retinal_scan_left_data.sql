SELECT "Creating new retinal_scan_left_data table" AS "";

CREATE TABLE IF NOT EXISTS retinal_scan_left_data (
  ...
  CONSTRAINT fk_retinal_scan_left_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_retinal_scan_left_data_stage_id
