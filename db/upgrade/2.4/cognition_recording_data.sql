SELECT "Creating new cognition_recording_data table" AS "";

CREATE TABLE IF NOT EXISTS cognition_recording_data (
  ...
  CONSTRAINT fk_cognition_recording_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_cognition_recording_data_stage_id
