SELECT "Creating new deviation_aecrf_data table" AS "";

CREATE TABLE IF NOT EXISTS deviation_aecrf_data (
  ...
  CONSTRAINT fk_deviation_aecrf_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_deviation_aecrf_data_stage_id
