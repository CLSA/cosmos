SELECT "Creating new contraindication_qnaire_data table" AS "";

CREATE TABLE IF NOT EXISTS contraindication_qnaire_data (
  ...
  CONSTRAINT fk_contraindication_qnaire_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_contraindication_qnaire_data_stage_id
