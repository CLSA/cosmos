SELECT "Creating new spirometry_data table" AS "";

CREATE TABLE IF NOT EXISTS spirometry_data (
  ...
  CONSTRAINT fk_spirometry_data_technician_id
    FOREIGN KEY (technician_id)
    REFERENCES technician (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_spirometry_data_stage_id
